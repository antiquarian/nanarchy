...
namespace Nanarchy.Data.MssqlHierarchyDataProvider
{
    public class MssqlHierarchyDataProvider : IHierarchyDataProvider
    {
        ...
        public IList<HierarchyNode> GetDescendants(HierarchyEntry hierarchyEntry, HierarchyNode parent, bool orderTopDown, bool includeParent)
        {
        ...
        public IList<HierarchyNode> GetAncestors(HierarchyEntry hierarchyEntry, HierarchyNode child, bool orderTopDown, bool includeChild)
        {
